...
exports.Optoin = function (props) { return (React.createElement(select_1.default.Option, __assign({}, props))); };
var SelectWrapper = /** @class */ (function (_super) {
    ...
    SelectWrapper.prototype.render = function () {
        ...
        return options ? (React.createElement(select_1.default, __assign({}, props), options.map(function (o) { return (React.createElement(exports.Optoin, __assign({}, o), o.label || o.title)); }))) : (React.createElement(select_1.default, __assign({}, this.props)));
    };
