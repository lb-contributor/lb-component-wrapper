...
var SimpleFormItem = exports.SimpleFormItem = function (_Form$Item) {
  ...
  _createClass(SimpleFormItem, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      var ret = changed || this.helpShow !== this.lastHelpShow || this.props.read !== nextProps.read || this.newGetChildProps(this.props, VALUE) !== this.newGetChildProps(nextProps, VALUE) || this.newGetChildProps(this.props, OPTIONS) !== this.newGetChildProps(nextProps, OPTIONS) || this.newGetChildProps(this.props, CHECKED) !== this.newGetChildProps(nextProps, CHECKED) || currField.validating !== nextField.validating || currField.value !== nextField.value || currField.errors !== nextField.errors || currField.initialValue !== nextField.initialValue;
